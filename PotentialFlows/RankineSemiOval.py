...
class RankineSemiOval(PotentialSolution):
    def __init__(self, ovalHalfHeight, uniformStrength, uniformAngle=0, sourceX=0, sourceY=0):
        ...
        self.sourceStrength = 2 * uniformStrength * ovalHalfHeight
        self.source = SourceSink(self.sourceStrength, sourceX, sourceY)
        self.uniform = UniformFlow(uniformStrength, uniformAngle)
        
        self.xSP = -self.sourceStrength / (2 * np.pi * uniformStrength)
        self.ySP = 0
